...
module.exports = function() {
    ...
    var layouts = {
        'GET': {
            '/example_module1': systemLayouts.defaultLayout.createSelf()
        }
    };

    layouts['GET']['/example_module1'].head.title = 'Example Module 1 - WebFwJs';

    // Wrapper Structural Block
    layouts['GET']['/example_module1'].middle.generalWrapperBlock = systemLayouts.abstractLayouts.createStructuralBlock();
    var generalWrapperBlock = layouts['GET']['/example_module1'].middle.generalWrapperBlock;

    generalWrapperBlock.trigger.module      = 'exampleModule1';
    generalWrapperBlock.trigger.file        = 'generalWrapperBlock';
    generalWrapperBlock.trigger.function    = 'generalWrapperBlockHtml';

    generalWrapperBlock.headMembers.requiredUILibs.css.push('assets/exampleModule1/stylesheets/exampleModule1.css');
    generalWrapperBlock.headMembers.requiredUILibs.js.push('assets/exampleModule1/javascripts/exampleModule1.js');
    ...
    structuralBlock1.trigger.module      = 'exampleModule1';
    ...
    contentBlock1.trigger.module      = 'exampleModule1';
    ...
    contentBlock2.trigger.module      = 'exampleModule1';
    contentBlock2.trigger.file        = 'exampleContentBlock2';
    contentBlock2.trigger.function    = 'exampleContentBlock2Html';

    contentBlock2.headMembers.requiredUILibs.css.push('assets/exampleModule1/stylesheets/contentBlock2.css');
    ...
    contentBlock3.trigger.module      = 'exampleModule1';
    ...
    structuralBlock2.trigger.module      = 'exampleModule1';
    ...
    contentBlock4.trigger.module      = 'exampleModule1';
    ...
    contentBlock5.trigger.module      = 'exampleModule1';
